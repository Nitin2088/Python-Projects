...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "face-attendance-system-1b6e8.appspot.com"
})
...
imgBackground = cv2.imread('D:\\Python\\Projects\\Face Attendance\\Resources\\background.png')
        ...
        if counter != 0:
            if counter == 1:
                ...
                if blob.exists():
                    ...
                    imgStudent = cv2.resize(imgStudent, (216, 216))  # Resize to match the destination size
                else:
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    cv2.putText(imgBackground, str(studentInfo['course']), (910, 625),
